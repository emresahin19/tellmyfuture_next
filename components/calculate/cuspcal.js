...
from "./hekichan.js";
export function calHouseCusp(ye, mo, da, ho, mi, pid){
...
export function calHouseCusp2(ye, mo, da, ho, mi, Lon, Lat, htype){
	var cusp = new Array();
...
export function calAsc(lst, lat, obl){
	// ASC�v�Z
...
export function calHousePlacidus(LST, Lat, obl){
...
export function calHouseCampanus(LST, Lat, obl){
...
export function calHouseRegiomontanus(LST, Lat, obl){
...
export function calHouseKoch(LST, Lat, obl){
	var K, dlst, csp, nh;
	var cusp = new Array();
...
export function calHouseTopocentric(LST, Lat, obl){
...
export function calHouseAxial(LST, Lat, obl){
	var alpha, cspx, cspy;
	var cusp = new Array();
...
export function calHouseMorinus(LST, Lat, obl){
	var Z, cspx, cspy;
	var cusp = new Array()
