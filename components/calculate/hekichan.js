...
export function calPlanetPosition2( ye, mo, da, ho, mi, lon, lat ){
	var i;
...
export function calPlaPos( JD, pid ){
...
export function calVsopTerm( T, term ){
	var res = 0.0;
...
export function calPositPL_mee( T ){
...
export function calPositPL_obspm( T ) {
	var T2 = T  * T;
	var T3 = T2 * T;
...
export function calSolarVelocity( JD ){
...
export function calLunarVelocity( JD ){
	var T = ( JD - 2451545.0 ) / 36525.0;
	var mf = new Array();
	var vel;
...
export function calPositLuna( JD ){
	var d = JD - 2451545.0;
	var T =  d / 36525.0;
...
export function calGeoPoint( lst, la, obl ){
	// MC�v�Z
	var MCx = sin4deg(lst);
