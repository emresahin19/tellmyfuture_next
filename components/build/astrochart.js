...
export default function buildChart(data, colors){
	...
	(function( astrology ) {
		...
		// BG color
		astrology.COLOR_BACKGROUND = colors.background;		 
					
		// Color of planet's symbols
		astrology.POINTS_COLOR = colors.points;
		...
		astrology.SIGNS_COLOR = colors.sign; 
		...
		astrology.CUSPS_FONT_COLOR = colors.cusps;	
		...
		// Aspects	
		astrology.ASPECTS = { 
			"conjunction":{"degree":0, "orbit":10, "color": colors.fire}, //transparent
			"square":{"degree":90, "orbit":8, "color": colors.fire}, //fire
			"trine":{"degree":120, "orbit":8, "color": colors.air}, //water
			"opposition":{"degree":180, "orbit":10, "color": colors.air} //water
			};	
