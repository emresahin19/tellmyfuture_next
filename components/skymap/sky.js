...
const config = {
  ...
  stars: {
    ...
    desig: false,
    namelimit: 2.5, 
    namestyle: { fill: "#ddddbb", font: "0px Georgia, Times, 'Times Roman', serif", align: "left", baseline: "top" },
    propernamestyle: { fill: "#ddddbb", font: "0px Georgia, Times, 'Times Roman', serif", align: "right", baseline: "bottom" },
    propernamelimit: 1.5,
    size: 7,
    exponent: -0.28,
    // data: 'stars.6.json' 
  ...
  dsos: {
    ...
    desig: false,
    namelimit: 4,
    namestyle: { fill: "#cccccc", font: "0px Helvetica, Arial, serif", align: "left", baseline: "top" },
    size: null,   
    exponent: 1.4,
  ...
  lines: {
    graticule: { show: false, stroke: "#cccccc", width: 0.3, opacity: 0.5, 
